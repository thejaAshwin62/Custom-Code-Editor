...
const QuickActionsPanel = ({
  ...
  return (
    <div
      ...
      } ${!sidebarOpen && !outputSidebarOpen ? "quick-actions-open" : "quick-actions-closed"}`}
    >
      {/* AI Assistant Toggle */}
      <button
        ...
        style={{
          boxShadow: sidebarOpen
            ...
            `
            : `
              inset 0 1px 0 ${theme === "dark" ? "rgba(255, 255, 255, 0.05)" : "rgba(255, 255, 255, 0.4)"},
              inset 0 -1px 0 ${theme === "dark" ? "rgba(0, 0, 0, 0.1)" : "rgba(0, 0, 0, 0.02)"}
            `,
        }}
      >
